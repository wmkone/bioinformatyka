...
> Pakiet NCBI Entrez Direct umożliwia dostęp do baz danych serwisu NCBI przy użyciu wiersza poleceń. Oprogramowanie jest zainstalowane na komputerach w sali ćwiczeniowej S2. Instrukcja instalacji NCBI E-utilities: https://www.ncbi.nlm.nih.gov/books/NBK179288/.
...
3. Wyświetl linie rekordów zaczynające się od `LOCUS` i uszereguj je ze względu na malejącą długość sekwencji.
   ...
   ```
   LOCUS       XM_054380041            8655 bp    mRNA    linear   PRI 05-AUG-2025
   LOCUS       XM_024450231            8653 bp    mRNA    linear   PRI 05-AUG-2025
   LOCUS       XM_054380042            8622 bp    mRNA    linear   PRI 05-AUG-2025
   ...
   ```
...
Uzupełnij trzecie polecenie, aby uzyskać poniższe informacje:

```
NM_014494      8491  mRNA  linear   Homo sapiens   2025/11/20
NM_001330520   8344  mRNA  linear   Homo sapiens   2025/11/20
NM_001351850   8506  mRNA  linear   Homo sapiens   2025/11/20
...
```
